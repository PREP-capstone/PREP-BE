...
_CACHE_KEY_PREFIX = "proposal_generation:v2:"
...
- 문장 종결은 제안서·사업계획서 문체로 통일합니다. 기본적으로 "~이다", "~한다", "~함"을
  사용하고, "~입니다", "~합니다", "~하세요"와 같은 존댓말·대화체 종결은 사용하지 않습니다.
- 표와 목록은 간결한 명사형 또는 서술형으로 작성하고, 문서 전체에서 종결 어미를 일관되게
  유지합니다.

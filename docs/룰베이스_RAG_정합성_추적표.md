...
- **등록된 문서 38건 중 실제 청킹 완료는 10건**(407 chunks) — 나머지는 metadata만 등록되고 본문 청킹 전 단계
- 청킹 완료 10건: 웰니스판단기준(30, 정상) · 비의료가이드 1차(35, 일반 참고용) · 비의료가이드 2차(31, 정상) · 개인정보보호법(149) · 시행령(133) · 별표7(18, 정상) · 약사법(5) · 의료기기법(2) · 의료기기법시행규칙(1) · 의료법(3, 정상)
